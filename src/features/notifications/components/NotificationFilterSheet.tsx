...
interface NotificationFilterSheetProps {
  ...
  onSelectCategory: (cat: NotificationCategory | 'All') => void;
  onClose: () => void;
}
      ...
      <View style={styles.overlay}>
        ...
        <View style={styles.sheetContainer}>
          ...
          <View style={styles.headerRow}>
            <Text style={styles.headerTitle}>Filter Notifications</Text>
          ...
          <ScrollView contentContainerStyle={styles.chipsWrap} showsVerticalScrollIndicator={false}>
            {CATEGORIES.map((cat) => {
              ...
              return (
                ...
                >
                  <NotificationCategoryChip category={cat} selected={isSelected} />
